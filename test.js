...
// let samir = products.map((item)=>{
//     console.log(item.category);
// })


let printedCategories = [];  // To keep track of printed categories

let samir = products.map((item) => {
    if (!printedCategories.includes(item.category)) {
        console.log(item.category);
        printedCategories.push(item.category);  // Add category to the list of printed categories
    }
});